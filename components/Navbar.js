    ...
    <nav className="py-6 px-8 flex justify-between items-center bg-white/50 dark:bg-black/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100/50 dark:border-[#1a1a1a] transition-colors">
      ...
      <div className="flex items-center space-x-6">
        <div className="hidden md:flex space-x-6 text-sm font-medium text-gray-500 dark:text-gray-400">
          <button type="button" className="hover:text-[#033487] dark:hover:text-[#00ff88] cursor-pointer transition-colors" onClick={() => console.log('Workspace clicked')}>Workspace</button>
          <button type="button" className="hover:text-[#033487] dark:hover:text-[#00ff88] cursor-pointer transition-colors" onClick={() => console.log('Team clicked')}>Team</button>
          <button type="button" className="hover:text-[#033487] dark:hover:text-[#00ff88] cursor-pointer transition-colors" onClick={() => console.log('Archive clicked')}>Archive</button>
        </div>
        <ThemeToggle />
      </div>
    </nav>
